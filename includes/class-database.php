 ...
 */
class LP_Addon_CourseInstances_Database {
	/**
	 * Creates the database tables required for course instances.
	 *
	 * @since 4.0.0
	 * @return void
	 */
	public static function create_tables() {
		...
		$table_instances = $wpdb->prefix . 'learnpress_course_instances';
	...
	// $table  = $wpdb->prefix . 'learnpress_course_instances';
	...
	// return learn_press_update_user_item_meta( $user_item_id, '_instance_id', $instance_id );
	// }
	...
	// $instances_table  = $wpdb->prefix . 'learnpress_course_instances';
	// $user_items_table = $wpdb->prefix . 'learnpress_user_items';
	...
	public static function get_total_unlinked_enrollments_count() {
		...
		// return $wpdb->get_var( $sql ); // db call ok
		return 0;
	}
